...
const registerUser = asyncHandler( async(req, res) => {
    ...
    // console.log(avatarLocalPath) -> public\temp\img.png
    ...
    // console.log(avatar) -> gives object with details including url
...
const updateUserAvatar = asyncHandler( async(req, res) => {
    ...
    if(!oldUser.avatar) {
        throw new ApiError(500, "Old avatar cannot be found")
    }
